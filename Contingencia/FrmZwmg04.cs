...
{
    public partial class FrmZwmg04 : FrmBase
    {
        ...
        private void FrmZwmg04_Activated(object sender, EventArgs e)
        {
            textCentro.Focus();
        }

        private void FrmZwmg04_Load(object sender, EventArgs e)
        {
        ...
        private void btnContinuar_Click(object sender, EventArgs e)
        {
            ...
            {
                ValidarDatos();
                FrmAsignarTarimasEntrega asignarTarimasEntrega = new FrmAsignarTarimasEntrega();
                asignarTarimasEntrega.IdEntrega = textEntrega.Text;
                asignarTarimasEntrega.IdCentro = textCentro.Text;
                asignarTarimasEntrega.IniciarForma();
                asignarTarimasEntrega.ShowDialog();
